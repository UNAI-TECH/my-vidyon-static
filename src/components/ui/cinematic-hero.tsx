...
export function CinematicHero({
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            gsap.set(".hero-logo", { autoAlpha: 0, x: -60, scale: 0.85, filter: "blur(20px)" });
            ...
            scrollTl
                ...
                .to([".text-track", ".text-days", ".text-solutions"], { scale: 1.5, filter: "blur(20px)", autoAlpha: 0, ease: "power2.inOut", duration: 2 }, 0)
                .to(".hero-logo", {
                    x: () => deltaX,
                    y: () => deltaY,
                    scale: () => targetScale,
    ...
    return (
        ...
        >
            ...
            <div className="hero-text-wrapper absolute inset-0 z-10 flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:justify-between max-w-7xl mx-auto px-4 lg:px-12 w-full will-change-transform transform-style-3d -translate-y-20">
                {/* LEFT: Logo */}
                <div className="hero-logo-wrapper w-full md:w-1/2 flex justify-center md:justify-start">
                    <img
                        src={logoSrc || "/logo.png"}
                        alt="Hero Logo"
                        className="hero-logo gsap-reveal w-[160px] sm:w-[200px] md:w-[350px] lg:w-[450px] xl:w-[500px] object-contain drop-shadow-2xl"
                    />
                </div>

                {/* RIGHT: Texts */}
                <div className="flex flex-col items-center justify-center text-center w-full md:w-1/2">
                    <h1 className="text-track gsap-reveal text-3d-matte text-4xl sm:text-5xl md:text-7xl lg:text-[80px] font-bold tracking-tight mb-2">
                        {tagline1}
                    </h1>
                    <h1 className="text-days gsap-reveal text-amber-matte text-4xl sm:text-5xl md:text-7xl lg:text-[80px] font-extrabold tracking-tight mb-1">
                        {tagline2}
                    </h1>
                    {tagline3 && (
