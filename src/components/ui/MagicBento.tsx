...
const DEFAULT_GLOW_COLOR = '250, 177, 47'; // My Vidyon Primary Orange RGB
                    ...
                    const content = (
                        <>
                            <div className="magic-bento-card__header">
                                <div className="magic-bento-card__label text-primary font-semibold">{card.label || 'Feature'}</div>
                                <div className="magic-bento-card__icon p-2 rounded-lg bg-primary/10">
